import numpy as np
from hal.hardware.servo_calibration import MICROS_PER_RAD, NEUTRAL_ANGLE_DEGREES
from hal.hardware.hardware_config import PS4_COLOR, PS4_DEACTIVATED_COLOR
...
class Configuration:
    def __init__(self):
        ...
        #################### STANCE ####################
        self.delta_x = 0.0648  # Match LEG_FB (64.8mm) to center stance relative to leg origins
        self.delta_y = 0.070   # Foot placement left/right (70mm) - calculated for 0° abduction with 36.75mm ABDUCTION_OFFSET
        self.x_shift = 0.0
        self.z_shift = 0.0
        ...
        ######################## GEOMETRY ######################
        self.LEG_FB = 0.0648  # front-back distance from center line to leg axis (updated from 59mm to 64.8mm)
        self.LEG_LR = 0.0385  # left-right distance from center line to leg plane (updated from 23.5mm to 38.5mm)
        self.LEG_L2 = 0.0735  # Calf length: 73.5mm (updated from 60mm)
        self.LEG_L1 = 0.0735  # Thigh length: 73.5mm (updated from 50mm)
        self.ABDUCTION_OFFSET = 0.03675  # distance from abduction axis to leg (updated from 26mm to 36.75mm)
        ...
        self.L = 0.207  # Overall robot length: 207mm (updated from 176mm)
        self.W = 0.090  # Overall robot width: 90mm (updated from 60mm)
        self.T = 0.045
...
class SimulationConfig:
    def __init__(self):
        self.XML_IN = "trotbot.xml"
        self.XML_OUT = "trotbot_out.xml"
